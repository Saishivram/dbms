...
const Register: React.FC = () => {
  ...
  return (
    <Box sx={{
          ...
          <Box sx={{
            ...
            >
              <Typography variant="body1" sx={{
                ...
                Create an account to manage your newspaper delivery business. Track deliveries, manage subscriptions, and optimize your distribution network.
              </Typography>
            </motion.div>
      ...
      >
        © {new Date().getFullYear()} Newspaper Delivery Management System
      </Typography>
    </Box>
  );
};
